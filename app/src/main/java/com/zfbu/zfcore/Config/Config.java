...
public class Config {
    ...
    public static String zfbNum = "";//收款支付宝账号
    public static String merNum = "";//商户号
    ...
    public static boolean runType = false; // 是否开启监控

    public static boolean sserRun = false; //服务是否开启
    public static boolean aserRun = false; //辅助是否开启
    public static boolean nserRun = false; //监控是否开启
